using BarberBossI.Application.UseCases.Expenses.Reports.Pdf.Colors;
using BarberBossI.Application.UseCases.Expenses.Reports.Pdf.Fonts;
...
namespace BarberBossI.Application.UseCases.Expenses.Reports.Pdf;
