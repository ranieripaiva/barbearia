...
namespace BarberBossI.Application.UseCases.Invoices.Reports.Pdf.Colors;
public static class ColorsHelper
{
    ...
    public static readonly Color GREEN_BLUE = Color.Parse("#205858");
    public static readonly Color GREEN_GRAY = Color.Parse("#D7DFDF");
