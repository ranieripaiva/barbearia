...
public class RegisterUserUseCaseTest
{
    ...
    {
        var mapper = MapperBuilder.Build(); //ok
        var unitOfWork = UnitOfWorkBuilder.Build(); //ok 
        var writeRepository = UserWriteOnlyRepositoryBuilder.Build(); //ok
        var passwordEncripter = new PasswordEncrypterBuilder().Build(); // ok
        var tokenGenerator = JwtTokenGeneratorBuilder.Build(); //ok 
        var readRepository = new UserReadOnlyRepositoryBuilder(); //ok 
