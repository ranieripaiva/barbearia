...
public class RegisterUserTest : BarberBossIClassFixture //IClassFixture<CustomWebApplicationFactory>
{
    ...
    public async Task Success()
    {
        ...
        //var response = await result.Content.ReadFromJsonAsync<ResponseRegisteredUserJson>();
    }
