...
public class BarberBossIClassFixture : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _httpClient;

    public BarberBossIClassFixture(CustomWebApplicationFactory webApplicationFactory)
    {
